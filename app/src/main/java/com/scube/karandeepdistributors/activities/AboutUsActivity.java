...
//        scrollView.fullScroll(View.FOCUS_DOWN);
        ...
        username = (TextView) navigationView.getHeaderView(0).findViewById(R.id.username8);
        userEmail = (TextView) navigationView.getHeaderView(0).findViewById(R.id.useremail8);
